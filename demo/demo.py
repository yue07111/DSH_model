...
data_dir = "/disks/sata4/huangyue/hy_DSH/DeepHash-hw/save/DSH/coco_Adam_48bits_0.1_0.7211806634023885/"
...
img_dir="/disks/sata4/huangyue/dataset/COCO_2014/"
#img_dir = "/dataset/imagenet/"
with open("/disks/sata4/huangyue/hy_DSH/DeepHash-hw/data/coco/database.txt", "r") as f:
    trn_img_path = [img_dir + item.split(" ")[0] for item in f.readlines()]
with open("/disks/sata4/huangyue/hy_DSH/DeepHash-hw/data/coco/test.txt", "r") as f:
