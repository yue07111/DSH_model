...
with open("/disks/sata4/huangyue/hy_DSH/DeepHash-pytorch/data/imagenet/database.txt", "r") as f:
    trn_img_path = np.array([img_dir + item.split(" ")[0] for item in f.readlines()])
save_path = "/disks/sata4/huangyue/hy_DSH/DeepHash-pytorch/save/DSH/cifar10-1_48bits_0.796466334728738/"
